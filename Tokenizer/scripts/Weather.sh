...
n_embeds=(128 256 512)

for n_embed in "${n_embeds[@]}"
do
    save_path="dependent/weather_${n_embed}_entropy"
    log_name=$model_id_name'_tok'$token_len'_emb'$n_embed'_wl'$wave_length'_'$vq_model'_'$pred_len'_seq_len'$seq_len'_dependent_entropy.log'
